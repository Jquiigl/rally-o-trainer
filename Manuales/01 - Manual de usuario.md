# Manual de usuario de Rally O Trainer
...
1. Escribe el nombre del perro.
2. Escribe su raza.
3. Pulsa **Crear perfil**.

No se solicita fotografía, correo, contraseña ni información de competición.
...
4. Confirma el nombre **Rally O Trainer**.
...
1. descripción reglamentaria de redacción propia;
2. explicación en lenguaje sencillo;
3. consejo de entrenamiento positivo;
4. criterios que conviene observar.
...
1. crea una pista y dale un nombre;
2. añade entre una y diez señales Debutante;
3. usa las flechas para ordenar y la cruz para quitar;
4. guarda para obtener una vista de preparación.
...
- **Exportar copia completa** descarga un archivo JSON con todos los datos;
- **Restaurar una copia** reemplaza los datos locales por los del archivo elegido.

Conviene exportar al menos una vez al mes y guardar el archivo en una ubicación distinta del teléfono. Borrar datos del navegador o desinstalar la PWA puede eliminar el almacenamiento local.
...
- Usa superficies y material seguros.
...
- El almacenamiento local puede perderse si el usuario borra los datos del sitio.
- Una valoración rápida depende de que guía y criterio sean consistentes.

## Mejoras posibles

- Añadir una ayuda contextual opcional durante el primer entrenamiento.
- Incorporar un recordatorio local de copia de seguridad.
- Añadir capturas de instalación desde la URL definitiva de GitHub Pages.
