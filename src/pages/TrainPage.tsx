...
export function TrainingModePage() {
  ...
  return <>
    ...
    <div className="mode-grid">
      <button className="mode-card" disabled={busy !== null} onClick={() => begin('repetition')}><span className="mode-icon">10×</span><strong>Entrenamiento individual</strong><span>Completa 10 intentos seguidos de cada señal antes de pasar a la siguiente.</span><small>Ideal para aprender o corregir una habilidad.</small></button>
      <button className="mode-card" disabled={busy !== null} onClick={() => begin('circuit')}><span className="mode-icon">↻</span><strong>Modo circuito</strong><span>Realiza todas las señales una vez y repite el conjunto durante 10 vueltas.</span><small>Ideal para fluidez, cambios y preparación de recorridos.</small></button>
    </div>
